...
/**
 * \brief Set CMP_OUT output & pull configuration
 *
 ...
 */
static inline void CMP_OUT_set_output_pull_mode(const enum port_output_pull_mode output_pull_mode)
{
	PORTA_set_pin_output_pull_mode(7, output_pull_mode);
}

/**
 * \brief Set CMP_OUT data direction
 *
 ...
 *                      (low power state)
 */
static inline void CMP_OUT_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(7, dir);
}

/**
 * \brief Set CMP_OUT input/sense configuration
 *
 * Enable/disable CMP_OUT digital input buffer and pin change interrupt,
 ...
 */
static inline void CMP_OUT_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(7, isc);
}

/**
 * \brief Set CMP_OUT inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on CMP_OUT is inverted
 *                     false = I/O on CMP_OUT is not inverted
 */
static inline void CMP_OUT_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(7, inverted);
}

/**
 * \brief Set CMP_OUT level
 *
 ...
 */
static inline void CMP_OUT_set_level(const bool level)
{
	PORTA_set_pin_level(7, level);
}

/**
 * \brief Toggle output level on CMP_OUT
 *
 * Toggle the pin level
 */
static inline void CMP_OUT_toggle_level()
{
	PORTA_toggle_pin_level(7);
}

/**
 * \brief Get level on CMP_OUT
 *
 * Reads the level on a pin
 */
static inline bool CMP_OUT_get_level()
{
	return PORTA_get_pin_level(7);
}

/**
 * \brief Set CMP_OUT interrupt level
 *
 * Sets interrupt level for port
 *
 * \param[in] level Value to write to the port register
 */
static inline void CMP_OUT_int_level(const uint8_t level)
{
	PORTA_set_int_level(level);
}

/**
 * \brief Set CMP_OUT interrupt vector 0 mask
 *
 * Sets interrupt mask for port vector 0
 *
 * \param[in] value Value to write to the port register
 */
static inline void CMP_OUT_int0_mask(const uint8_t value)
{
	PORTA_write_int0_mask(value);
}

/**
 * \brief Set CMP_OUT interrupt vector 1 mask
 *
 * Sets interrupt mask for port vector 1
 *
 * \param[in] value Value to write to the port register
 */
static inline void CMP_OUT_int1_mask(const uint8_t value)
{
