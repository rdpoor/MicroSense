...
/**
 * \brief Set COMP_P output & pull configuration
 *
 ...
 */
static inline void COMP_P_set_output_pull_mode(const enum port_output_pull_mode output_pull_mode)
{
	PORTA_set_pin_output_pull_mode(0, output_pull_mode);
}

/**
 * \brief Set COMP_P data direction
 *
 ...
 *                      (low power state)
 */
static inline void COMP_P_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(0, dir);
}

/**
 * \brief Set COMP_P input/sense configuration
 *
 * Enable/disable COMP_P digital input buffer and pin change interrupt,
 ...
 */
static inline void COMP_P_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(0, isc);
}

/**
 * \brief Set COMP_P inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on COMP_P is inverted
 *                     false = I/O on COMP_P is not inverted
 */
static inline void COMP_P_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(0, inverted);
}

/**
 * \brief Set COMP_P level
 *
 ...
 */
static inline void COMP_P_set_level(const bool level)
{
	PORTA_set_pin_level(0, level);
}

/**
 * \brief Toggle output level on COMP_P
 *
 * Toggle the pin level
 */
static inline void COMP_P_toggle_level()
{
	PORTA_toggle_pin_level(0);
}

/**
 * \brief Get level on COMP_P
 *
 * Reads the level on a pin
 */
static inline bool COMP_P_get_level()
{
	return PORTA_get_pin_level(0);
}

/**
 * \brief Set COMP_P interrupt level
 *
 * Sets interrupt level for port
 *
 * \param[in] level Value to write to the port register
 */
static inline void COMP_P_int_level(const uint8_t level)
{
	PORTA_set_int_level(level);
}

/**
 * \brief Set COMP_P interrupt vector 0 mask
 *
 * Sets interrupt mask for port vector 0
 *
 * \param[in] value Value to write to the port register
 */
static inline void COMP_P_int0_mask(const uint8_t value)
{
	PORTA_write_int0_mask(value);
}

/**
 * \brief Set COMP_P interrupt vector 1 mask
 *
 * Sets interrupt mask for port vector 1
 *
 * \param[in] value Value to write to the port register
 */
static inline void COMP_P_int1_mask(const uint8_t value)
{
