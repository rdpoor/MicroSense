...
/**
 * \brief Set COMP_N output & pull configuration
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] output_pull_mode Pin output & pull mode
 */
static inline void COMP_N_set_output_pull_mode(const enum port_output_pull_mode output_pull_mode)
{
	PORTA_set_pin_output_pull_mode(1, output_pull_mode);
}

/**
 * \brief Set COMP_N data direction
 *
 * Select if the pin data direction is input, output or disabled.
 * If disabled state is not possible, this function throws an assert.
 *
 ...
 *                      (low power state)
 */
static inline void COMP_N_set_dir(const enum port_dir dir)
{
	PORTA_set_pin_dir(1, dir);
}

/**
 * \brief Set COMP_N input/sense configuration
 *
 * Enable/disable COMP_N digital input buffer and pin change interrupt,
 * select pin interrupt edge/level sensing mode
 *
 * \param[in] isc PORT_ISC_BOTHEDGES_gc     = Sense Both Edges
 *                PORT_ISC_RISING_gc        = Sense Rising Edge
 ...
 *                PORT_ISC_LEVEL_gc         = Sense low Level
 */
static inline void COMP_N_set_isc(const PORT_ISC_t isc)
{
	PORTA_pin_set_isc(1, isc);
}

/**
 * \brief Set COMP_N inverted mode
 *
 * Enable or disable inverted I/O on a pin
 *
 * \param[in] inverted true  = I/O on COMP_N is inverted
 *                     false = I/O on COMP_N is not inverted
 */
static inline void COMP_N_set_inverted(const bool inverted)
{
	PORTA_pin_set_inverted(1, inverted);
}

/**
 * \brief Set COMP_N level
 *
 * Sets output level on a pin
 *
 * \param[in] level true  = Pin level set to "high" state
 *                  false = Pin level set to "low" state
 */
static inline void COMP_N_set_level(const bool level)
{
	PORTA_set_pin_level(1, level);
}

/**
 * \brief Toggle output level on COMP_N
 *
 * Toggle the pin level
 */
static inline void COMP_N_toggle_level()
{
	PORTA_toggle_pin_level(1);
}

/**
 * \brief Get level on COMP_N
 *
 * Reads the level on a pin
 */
static inline bool COMP_N_get_level()
{
	return PORTA_get_pin_level(1);
}

/**
 * \brief Set COMP_N interrupt level
 *
 * Sets interrupt level for port
 *
 * \param[in] level Value to write to the port register
 */
static inline void COMP_N_int_level(const uint8_t level)
{
	PORTA_set_int_level(level);
}

/**
 * \brief Set COMP_N interrupt vector 0 mask
 *
 * Sets interrupt mask for port vector 0
 *
 * \param[in] value Value to write to the port register
 */
static inline void COMP_N_int0_mask(const uint8_t value)
{
	PORTA_write_int0_mask(value);
}

/**
 * \brief Set COMP_N interrupt vector 1 mask
 *
 * Sets interrupt mask for port vector 1
 *
 * \param[in] value Value to write to the port register
 */
static inline void COMP_N_int1_mask(const uint8_t value)
{
	PORTA_write_int1_mask(value);
}
...
/**
 * \brief Set RXD output & pull configuration
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] output_pull_mode Pin output & pull mode
 */
static inline void RXD_set_output_pull_mode(const enum port_output_pull_mode output_pull_mode)
{
...
/**
 * \brief Set RXD interrupt level
 *
 * Sets interrupt level for port
 *
 * \param[in] level Value to write to the port register
 */
static inline void RXD_int_level(const uint8_t level)
{
	PORTD_set_int_level(level);
}

/**
 * \brief Set RXD interrupt vector 0 mask
 *
 * Sets interrupt mask for port vector 0
 *
 * \param[in] value Value to write to the port register
 */
static inline void RXD_int0_mask(const uint8_t value)
{
	PORTD_write_int0_mask(value);
}

/**
 * \brief Set RXD interrupt vector 1 mask
 *
 * Sets interrupt mask for port vector 1
 *
 * \param[in] value Value to write to the port register
 */
static inline void RXD_int1_mask(const uint8_t value)
{
	PORTD_write_int1_mask(value);
}

/**
 * \brief Set TXD output & pull configuration
 *
 * Configure pin to pull up, down or disable pull mode, supported pull
 * modes are defined by device used
 *
 * \param[in] output_pull_mode Pin output & pull mode
 */
static inline void TXD_set_output_pull_mode(const enum port_output_pull_mode output_pull_mode)
{
...
/**
 * \brief Set TXD interrupt level
 *
 * Sets interrupt level for port
 *
 * \param[in] level Value to write to the port register
 */
static inline void TXD_int_level(const uint8_t level)
{
	PORTD_set_int_level(level);
}

/**
 * \brief Set TXD interrupt vector 0 mask
 *
 * Sets interrupt mask for port vector 0
 *
 * \param[in] value Value to write to the port register
 */
static inline void TXD_int0_mask(const uint8_t value)
{
	PORTD_write_int0_mask(value);
}

/**
 * \brief Set TXD interrupt vector 1 mask
 *
 * Sets interrupt mask for port vector 1
 *
 * \param[in] value Value to write to the port register
 */
static inline void TXD_int1_mask(const uint8_t value)
{
	PORTD_write_int1_mask(value);
}
